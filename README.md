...
:art: [Portfolio (built in Rails)](https://www.sdawes.com)<br>
...
|-----------------|-------------|--------------|
|[**Personal Portfolio Web App**](https://www.sdawes.com)|A personal portfolio and blogging site built in Ruby on Rails, HTML and SCSS. Demonstrates MVC and CRUD processes, database management, pagination, user authentication, CSS layout, hosting on Heroku and AWS. Link to app: https://www.sdawes.com. Link to code on github: https://github.com/sdawes/rails_portfolio  |Ruby, Rails, SCSS, HTML, Heroku, AWS.
